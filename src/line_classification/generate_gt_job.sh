...
#SBATCH --output=gt_hypersim_job.out # specify a file to direct standard output stream,

#SBATCH --account=3dv # mandatory course tag
#SBATCH --error=gt_hypersim_job.err # specify a file to direct standard error stream
...
cd "${HOME}/3D-Vision/DeepLSD/notebooks/" # path to your project folder
# your command
python generate_gt_hypersim.py