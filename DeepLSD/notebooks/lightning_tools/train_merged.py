...
def main(config_path: str):
    ...
    jk_layer_val = cfg_model.get('jk_layer', None)
    ...
    logger = WandbLogger(
        ...
        project=cfg_train.get('wandb_project', "3D_Vision_concat"), # W&B project name (REQUIRED)
    ...
    if accelerator_cfg == 'auto':
        ...
        # Add elif for MPS (mac) or other accelerators if needed
        # elif torch.backends.mps.is_available():
        #     actual_accelerator = 'mps'
        else:
