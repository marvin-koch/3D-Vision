...
#SBATCH --output=precompute_job.out # specify a file to direct standard output stream,

#SBATCH --account=3dv # mandatory course tag
#SBATCH --error=precompute_job.err # specify a file to direct standard error stream
...
srun python precompute_data.py --config=config_matin.yaml