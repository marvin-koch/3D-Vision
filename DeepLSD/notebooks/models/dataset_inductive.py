...
class GraphDatasetInductive(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        data_object = Data(x=x_emb, y=y, edge_index=edge_index, edge_labels=edge_labels, roi_features=roi_features, edge_list_full=edge_list_full)
